...
namespace AIS_Cinema.Migrations
{
    ...
    [Migration("20240609180821_ManyToManyForMoviesGenresCountries")]
    partial class ManyToManyForMoviesGenresCountries
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AIS_Cinema.Models.Visitor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEImV5D/mAsr2FvfWr10Af5/esSNQKGkD6I6MyoDOLliAexQx4VIrnzl+9i9zDGOPgg==",
