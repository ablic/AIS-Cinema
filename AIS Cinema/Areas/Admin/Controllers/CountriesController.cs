...
namespace AIS_Cinema.Areas.Admin.Controllers
{
    ...
    public class CountriesController : Controller
    {
        ...
        public CountriesController(AISCinemaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,ShortName")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,ShortName")] Country country)
        {
            if (id != country.Id)
            {
                return NotFound();
