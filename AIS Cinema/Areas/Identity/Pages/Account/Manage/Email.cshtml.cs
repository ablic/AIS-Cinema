    ...
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            await _emailSender.SendEmailAsync(
                ...
                $"Пожалуйста, подтвердите вашу почту, нажав на <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>эту ссылку</a>.");

            StatusMessage = "Письмо подтверждения адреса электронной почты отправлено. Пожалуйста, проверьте вашу электронную почту.";
            return RedirectToPage();
        }
    }
}
